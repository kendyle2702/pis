...
public enum ErrorCode {
    ...
    HAVE_SENDED_REQUEST_FRIEND(4021,"You have been sent a friend request by this person!", HttpStatus.BAD_REQUEST),
    HAVE_NOT_USER_SEND_REQUEST_FRIEND(4022,"They have not sent a friend request to you!",HttpStatus.BAD_REQUEST),
    ;
